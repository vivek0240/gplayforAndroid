...
* `GoogleNow` - To Exclude/Include [Google Now Launcher](https://play.google.com/store/apps/details?id=com.google.android.launcher) _(requires `Search`)_ [Super/Stock/Full/Mini/Micro]
...
* `PixelIcons` - To Exclude/Include Google Pixel Icons [Super/Stock]
* `PixelLauncher` - To Exclude/Include [Pixel Launcher](https://play.google.com/store/apps/details?id=com.google.android.apps.nexuslauncher) _(requires `Search` and `Wallpapers`)_ [Super/Stock]
...
* `Wallpapers` - To Exclude/Include [Wallpapers](https://play.google.com/store/apps/details?id=com.google.android.apps.wallpaper) [Super/Stock]
