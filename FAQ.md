...
####8. I read that 'Google Dialer can not be installed on my device' What does this mean?
...
####10. Open GApps install failed with the message 'Insufficient storage space available in System partition'. My device has 16GB (or more) of storage available. How can this be?
...
####11. I'd like to switch to Open GApps from another GApps provider. What do I need to do?
...
####12. What do I need to do if I want to change package variant or change the apps I'm installing?
...
####13. Can I use Open GApps to update the Google Apps on my Stock ROM?
...
####14. I'm having problems with Google Camera after installing Open GApps Stock. Please fix it!
...
####15. Open GApps packages are so big. Will I have any space left over for my stuff after I install?
...
####16. Why are Open GApps packages so much larger and slower to install than other GApps packages?
...
####17. Is it necessary to reinstall Open GApps EVERY time I update my ROM?
...
####18. What if an app is updated in the Play Store? Should I install the update or wait for a GApps update?
...
####19. Can I install an updated Open GApps package without updating my ROM?
...
####20. How come you don't include {MyFavoriteApp} in Open GApps?
...
####21. I found a newer version of {MyFavoriteApp} on APKMirror.com. How come you didn't include it in the latest GApps?
...
####22. There are a couple of apps I never use. Can I uninstall them?
...
####23. How do I Freeze / Disable an app?
By going to Settings > Apps > {scroll to ALL} > {select app} > Disable.

####24. Can I use Titanium Backup to integrate GApps updates into the ROM?
