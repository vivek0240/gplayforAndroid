...
####6. I read that 'Google Dialer can not be installed on my device' What does this mean?
...
####9. I'd like to switch to Open GApps from another GApps provider. What do I need to do?
...
####10. What do I need to do if I want to change package variant or change the apps I'm installing?
...
####11. Can I use Open GApps to update the Google Apps on my Stock ROM?
...
####12. I'm having problems with Google Camera after installing Open GApps Stock. Please fix it!
...
####13. Open GApps packages are so big. Will I have any space left over for my stuff after I install?
...
####14. Why are Open GApps packages so much larger and slower to install than other GApps packages?
...
####15. Is it necessary to reinstall Open GApps EVERY time I update my ROM?
...
####16. What if an app is updated in the Play Store? Should I install the update or wait for a GApps update?
...
####17. Can I install an updated Open GApps package without updating my ROM?
...
####18. How come you don't include {MyFavoriteApp} in Open GApps?
...
####19. I found a newer version of {MyFavoriteApp} on APKMirror.com. How come you didn't include it in the latest GApps?
...
####20. There are a couple of apps I never use. Can I uninstall them?
...
####21. How do I Freeze / Disable an app?
By going to Settings > Apps > {scroll to ALL} > {select app} > Disable.

####22. Can I use Titanium Backup to integrate GApps updates into the ROM?
